...
FM_INHERITABLE_CONFIG="${FM_INHERITABLE_CONFIG:-crew-dispatch.json crew-harness crew-remote-control backlog-backend backend herdr-presentation-spaces startup-memory-budget trace-context}"
